...
public class Bank_MenuList {
	...
	private static void listAllCustomers() {
		System.out.println("listing all availble customers...");
	...
	private static void addCustomer() {
		...
		try {
			do {
				...
				bank.setAtmPin(Bank.generatePinNumber());
	...
	private static void updateCustomer() {
		...
		do {
			...
			if (choice == 1) {
				...
				System.out
						.println("Enter the new Mobile number to be updated:");
